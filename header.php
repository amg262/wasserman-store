...
<div id="page" class="hfeed site">
		  ...
		  <?php if ( get_theme_mod( 'store_logo' ) != "" ) : ?>
            <div id="site-logo">
              <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img
                        class="wass-logo" src="<?php echo esc_url( get_theme_mod( 'store_logo' ) ); ?>"></a>
            </div>
		  <?php endif; ?>
        <div id="text-title-desc">
          <h1 class="site-title title-font"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"
          ...
          <div id="top-cart">
            <div class="top-cart-icon">
              ...
              <a class="cart-contents" href="<?php echo WC()->cart->get_cart_url(); ?>"
                 title="<?php _e( 'View your shopping cart', 'store' ); ?>">
      ...
      <div class="container">
		  ...
		  <?php /*if (! is_user_logged_in() ) { ?>
				<?php if (has_nav_menu(  'primary' ) && !get_theme_mod('store_disable_nav_desc') ) :
							...
							*/ ?>
		  <?php
		  if ( has_nav_menu( 'primary-user' ) && ! get_theme_mod( 'store_disable_nav_desc' ) ) :
			  wp_nav_menu( [ 'theme_location' => 'primary-user', 'walker' => $walker ] );
		  else :
			  wp_nav_menu( [ 'theme_location' => 'primary-user' ] );
		  endif; ?>
		  <?php //} ?>
      </div>
    </nav><!-- #site-navigation -->
  ...
  <div class="mega-container">
    ...
    <div id="content" class="site-content container">
      ...
      <form role="search" method="get" style="" class="search-form mobile_search"  action="<?php echo get_site_url(); ?>">
        <label>
